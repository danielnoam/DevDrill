...
// {
//     [Serializable]
//     public class SetIconPosition : EffectBase
//     {
...
//         [Tooltip("If true, the effect will use the default position of the icon image. If false, it will use the start value.")]
...
//             var position = useDefaultPosition ? VFXManager.Instance.DefaultIconPosition : startPosition;
//             
