...
//         [Tooltip("If true, the effect will use the default scale of the fullscreen image. If false, it will use the start value.")]
...
//             var scale = useDefaultScale ? VFXManager.Instance.DefaultFullScreenScale : startScale;
//             
...
//             if (_image)
//             {
//                 _image.rectTransform.localScale = VFXManager.Instance.DefaultFullScreenScale;
//                 if (_sequence.isAlive) _sequence.Stop();
//             }
//         }
//     }
