...
// {
//     [Serializable]
//     public class SetIconRotation : EffectBase
//     {
...
//         [Tooltip("If true, the effect will use the default rotation of the icon image. If false, it will use the start value.")]
...
//             var rotation = useDefaultRotation ? VFXManager.Instance.DefaultIconRotation : startRotation;
//             
...
//             if (_image)
//             {
//                 _image.rectTransform.localEulerAngles = VFXManager.Instance.DefaultIconRotation;
//                 if (_sequence.isAlive) _sequence.Stop();
//             }
//         }
//     }
